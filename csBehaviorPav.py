...
class csVariables(object):
	def __init__(self,sesVarDict={},sensory={},timing={},optical={}):
		...
		'rewardDur':1700,'lickAThr':3900,'lickLatchA':0,'minNoLickTime':1000,\
		...
		'trialTime_min':5000,'trialTime_max':11000,'trialTime_steps':[':',1],'trialTime_probs':[0.0,0.0],\
		'noLickTime_min':599,'noLickTime_max':2999,'noLickTime_steps':[':',1],'noLickTime_probs':[0.0,0.0],\
		'visualStimTime_min':2000,'visualStimTime_max':5000,'visualStimTime_steps':[':',4],'visualStimTime_probs':[1,0],\
		...
		'c1_amp_min':0,'c1_amp_max':4000,'c1_amp_steps':[500,1000,1500,2000,2500,3000,3500],'c1_amp_probs':[0,1],\
					...
					if csVar.pyState == 1:
						...
						if csVar.curStateTime>csVar.sesVarDict['minStim']:
							if csVar.reported==1:
								print("false alarm")
								csVar.attributeLabels = ['stimTrials','noStimTrials','responses','binaryStim','trialDurs']
								print("debug: did this print 1?")
								csVar.attributeData[csVar.attributeLabels.index('responses')].append(1)
								print("debug: did this print 2?")
								csVar.attributeData[csVar.attributeLabels.index('noStimTrials')].append(csVar.sesVarDict['trialNum'])
								print("debug: did this print 3?")
								csVar.attributeData[csVar.attributeLabels.index('binaryStim')].append(0)
								print("debug: did this print 4?")
								csVar.stateSync=0
								print("debug: did this print 5?")
								csVar.pyState=5
								print("debug: did this print 6?")
								csSer.teensy.write('a5>'.encode('utf-8'))
								print("debug: did this print 7?")
